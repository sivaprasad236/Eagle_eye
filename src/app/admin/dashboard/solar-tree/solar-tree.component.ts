...
export class DynamicDatabase {
  ...
  public getData(docId: string): Promise<any> {
    ...
    let url = this.GlobalServices.ApiUrls().getSolar;
...
@Component({
  selector: 'app-solar-tree',
  templateUrl: './solar-tree.component.html',
  styleUrls: ['./solar-tree.component.scss'],
  providers: [DynamicDatabase]
})
export class SolarTreeComponent implements OnInit {
